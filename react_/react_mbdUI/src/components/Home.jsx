...
function Home() {
  return (
    <section class="text-gray-600 body-font">
      <h1 className="mx-auto mt-5 justify-center items-center flex text-4xl font-medium text-gray-900">
        Welcome All!
      </h1>
      <div class="container mx-auto flex px-5 py-8 items-center justify-center flex-col">
        <img
          ...
          alt="hero"
          src="/src/assets/Notebook-Wallpaper-Free-Download-1_digital_art_x.jpg"
        />
