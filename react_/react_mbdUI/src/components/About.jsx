  ...
  return (
    <div>
      <div class="container mx-auto flex px-5 py-8 items-center justify-center flex-col">
        ...
        <p className="text-gray-600 mb-8">This is the about page</p>
        <img
          class="lg:w-2/6 md:w-3/6 w-5/6 mb-8 object-cover object-center rounded"
          alt="hero"
          src="/dolphin-night-orca-whale-digital-art-11-3840x2400.jpg"
        />
        <p>
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Quisquam
          voluptas, quia, quos, quod, quasi, officia, deleniti, ipsa
          consequuntur repellat quaerat quae. Quisquam, quibusdam. Quod,
          quibusdam. Quod, quibusdam. Quod, quibusdam. Quod, quibusdam. Quod,
        </p>
      </div>
